...
export default function Header() {
    return (
        <nav className="p-5 border-b-2 flex flex-row justify-between items-centre">
            <h1 className="bg-blue-400 text-white py-4 px-4 font-bold text-3xl">NFT Marketplace</h1>
            <div className="flex flex-row items-center">
                <Link href="/">
                    <a className="mr-4 p-6 text-blue-600 font-bold">Home</a>
                </Link>

                <Link href="/sell-nft">
                    <a className="mr-4 p-6 text-blue-600 font-bold">Sell NFT</a>
                </Link>
